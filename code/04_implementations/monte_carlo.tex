...
Para opciones con barreras, aumentar $N$ reduce el sesgo de discretización en el monitoreo de la barrera. Se recomienda usar al menos $N=50$ para barreras cercanas al precio inicial y $N=100 \text{ a } 252$ para aplicaciones que requieren alta precisión.
