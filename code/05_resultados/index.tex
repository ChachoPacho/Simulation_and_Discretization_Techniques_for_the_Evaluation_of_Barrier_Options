...
\begin{table}[H]
  \centering
  \caption{Comparación de Valoración para Put Americana (Diferencias Finitas vs. LSM). Parámetros: $K=40$, $r=0.06$, $\sigma=0.20$. Simulación LSM con 100,000 trayectorias, 50 pasos temporales, 3 polinomios de Laguerre.}
...
\bf{La introducción de esta barrera somete al algoritmo LSM a un doble esfuerzo computacional.}
