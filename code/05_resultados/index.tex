...
\subsection{Superando el ``Problema del Límite'': AMM vs. Trinomial Estándar}
...
\begin{table}[H]
  ...
  \makebox[\textwidth][c]{%
    \begin{tabular}{c|c|c|c}
      \hline
      \textbf{Precio Inicial} & \textbf{Valor Analítico} & \textbf{Trinomial Estándar} & \textbf{AMM} \\
...
\begin{table}[H]
  ...
  \makebox[\textwidth][c]{%
    \begin{tabular}{l|c|c|c}
      ...
      \hline
      Portafolio (6 ajustes / frec. bimestral) & 2.284 & +0.371 & $\approx$19.4\% \\
      Portafolio (24 ajustes / frec. quincenal) & 2.010 & +0.097 & $\approx$5.0\% \\
      \hline
    \end{tabular}
  }
\end{table}
...
\begin{table}[H]
  ...
  \makebox[\textwidth][c]{%
    \begin{tabular}{l|l|c|c}
      \hline
      \textbf{Método de} & \textbf{Enfoque} & \textbf{Valor} & \textbf{Err. Abs.} \\
      \textbf{Valoración} & \textbf{Principal} & \textbf{Calculado} & \textbf{vs R\&R} \\
      \hline
      R\&R & Teórico Exacto (Oráculo) & 1.913 & --- \\
      \hline
      AMM & Precisión Numérica (Nivel M=2) & 1.913 & $<$0.001 \\
...
\begin{table}[H]
  ...
  \makebox[\textwidth][c]{%
    \begin{tabular}{c|c|c|c}
      \hline
      \textbf{Simulaciones} & \textbf{Err. Estándar} & \textbf{Int. de Confianza} & \textbf{Tiempo} \\
  ...
  \makebox[\textwidth][c]{%
    \begin{tabular}{l|l|l|l|l}
      ...
      \textbf{Método} & \textbf{Naturaleza} & \textbf{Precisión} & \textbf{Costo} & \textbf{Flexibilidad /} \\
       &  & \textbf{Numérica} & \textbf{Comp.} & \textbf{Extensibilidad} \\
      \hline
      R\&R & Analítica & Exacta & Instantáneo & Muy Baja \\
       & / Continua & (Teórica) & (Bajo) & - Solo Europeas \\
      \hline
      AMM & Red Discreta & Muy Alta & Muy Bajo & Moderada \\
       & (Determinista) &  & $O(N)$ & - Opciones 1D \\
      \hline
      Replicación & Portafolio de & Moderada & Bajo & Alta \\
      Estática & Mercado & / Alta &  & (Depende del mercado) \\
      \hline
      LSM & Simulación & Moderada & Alto & Muy Alta \\
      & (Estocástica) & (SE) & $O(1/\sqrt{M})$ & - Americanas \\
      & & & & - Multi-activo \\
      \hline
    \end{tabular}
  }
