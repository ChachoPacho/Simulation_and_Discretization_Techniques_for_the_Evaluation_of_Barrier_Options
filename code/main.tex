...
\input{./04_implementations/index.tex} \cleardoublepage % Cap 4: Implementaciones (4 métodos)

\input{./05_resultados/index.tex} \cleardoublepage % Cap 5: Resultados

\input{./06_conclusiones/index.tex} \cleardoublepage % Cap 6: Conclusiones
