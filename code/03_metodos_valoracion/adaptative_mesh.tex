...
\section{Fundamentos: Árboles Trinomiales}
...
\section{Análisis de Errores en Modelos de Redes}
...
\begin{itemize}
    ...
    \item \textbf{Flujo de información}: A diferencia del AMM para vanilla, acá la información fluye de la malla gruesa hacia la malla fina para valorar la opción cuando $S_0$ está cerca de $H$
\end{itemize}
