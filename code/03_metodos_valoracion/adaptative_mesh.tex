...
% FIGURA 8: Gráfico de rendimiento RMSE vs Tiempo
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{./03_metodos_valoracion/figures/rmse_vs_time.png}
\caption{Gráfico de dispersión mostrando RMSE (eje Y, escala logarítmica) vs Tiempo de ejecución (eje X, escala logarítmica). Cada punto representa un modelo de la tabla anterior. Usar diferentes colores/símbolos para Binomial, Trinomial, AMM-1, AMM-2. Mostrar claramente cómo AMM logra menor error con tiempo similar al trinomial estándar. Incluir líneas de tendencia o regiones sombreadas para destacar la ``frontera de eficiencia''.}
