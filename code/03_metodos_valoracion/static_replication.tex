...
El concepto central de la replicación estática radica en igualar los flujos de caja y los valores de frontera de la opción objetivo utilizando un portafolio de instrumentos más simples. En este contexto, se denomina ``frontera'' a los límites espaciales y temporales que definen el contrato de la opción, típicamente, esto incluye el nivel de precio del activo subyacente que actúa como barrera (donde la opción se activa o desactiva) y la fecha de vencimiento.
