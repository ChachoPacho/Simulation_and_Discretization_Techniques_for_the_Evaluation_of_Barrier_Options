...
\begin{itemize}
    ...
    El factor exponencial $e^{2\eta \alpha \lambda \sigma^{-2}}$ es precisamente la manifestación matemática del principio de reflexión, cada trayectoria que cruza la barrera tiene una trayectoria ``reflejada'' correspondiente, y la densidad $g(u)$ pondera estas trayectorias reflejadas de manera apropiada. 
